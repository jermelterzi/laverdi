...
// in laverdi/test/src/data/services/secure_database_test.dart.
...
class MockBox extends _i1.Mock implements _i2.Box<Map<String, dynamic>> {
  @override
  Iterable<Map<String, dynamic>> get values => (super.noSuchMethod(
  ...
  @override
  Map<String, dynamic>? getAt(int? index) => (super.noSuchMethod(
        Invocation.method(
          #getAt,
          [index],
        ),
  ...
  @override
  Map<dynamic, Map<String, dynamic>> toMap() => (super.noSuchMethod(
        Invocation.method(
          #toMap,
          [],
        ),
  ...
  @override
  _i3.Future<void> putAll(Map<dynamic, Map<String, dynamic>>? entries) =>
      (super.noSuchMethod(
        Invocation.method(
          #putAll,
          [entries],
  ...
  @override
  _i3.Future<int> add(Map<String, dynamic>? value) => (super.noSuchMethod(
        Invocation.method(
          #add,
          [value],
        ),
  ...
  @override
  _i3.Future<Iterable<int>> addAll(Iterable<Map<String, dynamic>>? values) =>
      (super.noSuchMethod(
        Invocation.method(
          #addAll,
          [values],
